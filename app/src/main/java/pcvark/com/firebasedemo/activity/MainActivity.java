...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btn_sign_out, btn_change_email, btn_change_password, btn_remove_user,btn_go_test;
    ...
    private void setClickListeners() {
        ...
        btn_go_test.setOnClickListener(this);
    ...
    private void init() {
        ...
        btn_go_test = findViewById(R.id.btn_go_test);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_go_test:
                buttonClickFunction(this);
                break;

        }

    }
    public void buttonClickFunction(MainActivity v)
    {
